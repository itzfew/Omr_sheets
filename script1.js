    ...
    for (let i = 0; i < questions.length; i += 10) {
      ...
      for (let j = 0; j < 2; j++) {
        ...
        if (subQuestions.length > 0) {
          ...
          // Create header row for each sub-table
          const subHeaderRow = document.createElement('tr');
          ['Q', 'a', 'b', 'c', 'd'].forEach(text => {
          ...
          subQuestions.forEach((question, index) => {
            ...
            questionNumberCell.textContent = question;
            subRow.appendChild(questionNumberCell);
            ...
            ['A', 'B', 'C', 'D'].forEach(option => {
              ...
              optionCircle.addEventListener("click", function() {
                ...
                const otherOptionCircles = subRow.querySelectorAll('.option-circle');
              ...
              optionCell.appendChild(optionCircle);
              subRow.appendChild(optionCell);
            });
